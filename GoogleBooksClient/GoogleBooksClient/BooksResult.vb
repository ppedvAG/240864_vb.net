...
Public Class Volumeinfo
    ...
    Public Property authors As ICollection(Of String)
    Public Property publisher As String
    Public Property publishedDate As String
    Public Property industryIdentifiers As ICollection(Of Industryidentifier)
...
Public Class Saleinfo
    ...
    Public Property offers As ICollection(Of Offer)
End Class
